...
(3, 2, 1, 'Put the dog outside', 'Let the dog out to do its business around noon.', true),
(4, 2, 2, 'Bring the dog inside', 'Bring the dog back inside after about 30 minutes.', true),
...
(7, 3, 1, 'Tidy the living room', 'Please tidy up the living room.', true),
(8, 4, 1, 'Rake the backyard', 'Rake leaves in the backyard and put them in garbage bags', true),
